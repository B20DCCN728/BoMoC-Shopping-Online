...
<!-- Note: Do not use arrow function. You must use normal function for this code -->
<script setup>
...
// Define Special Characters Emoji
...
// Define custom mention user item renderer
...
const editorData = ref(`
            <h1>Discover the riches of our editor ✨</h1>
				...
				<ul>
					<li>
						<strong>customizable</strong>. You can fine-tune the set of enabled plugins, available toolbar buttons, and the behavior of features.
					</li>
					<li>
						The editor supports
					...
					<li>
						...
						from Word or Google Docs, retaining the original document structure and formatting.
					</li>
					<li>
						Thanks to Import from Word
						<img src="https://ckeditor.com/assets/images/ckdemo/feature-rich/import_word.png" srcset="https://ckeditor.com/assets/images/ckdemo/feature-rich/import_word.png 2x" alt="Import from Word" width="20" height="20" />, you can
					...
					<li>
						...
						to PDF
						<img src="https://ckeditor.com/assets/images/ckdemo/feature-rich/export_pdf.png" srcset="https://ckeditor.com/assets/images/ckdemo/feature-rich/export_pdf.png 2x" alt="Export to PDF" width="20" height="20" />
						or Word
						<img src="https://ckeditor.com/assets/images/ckdemo/feature-rich/export_word.png" srcset="https://ckeditor.com/assets/images/ckdemo/feature-rich/export_word.png 2x" alt="Export to Word" width="20" height="20" />
						with a single click.
					</li>
					<li>
						This demo showcases
						<a target="_blank" rel="noopener noreferrer" href="https://ckeditor.com/ckbox/">CKBox</a>
						<img src="https://ckeditor.com/assets/images/ckdemo/feature-rich/browse-files.png" srcset="https://ckeditor.com/assets/images/ckdemo/feature-rich/browse-files.png 2x" alt="Browse files" width="20" height="20" />
						to
						<strong>manage images and other files</strong>. You can enable your own upload adapter instead.
					</li>
				</ul>
				<h2>🚀 Autoformatting in CKEditor 5</h2>
				<p>
					Some features of CKEditor 5 might be hard to spot at first glance. Thanks to
					<strong>autoformatting</strong>, you can use handy shortcuts in the editor to format the text on the fly:
				</p>
`);
...
const editorConfig = ref({
	...
	exportPdf: {
		stylesheets: ['EDITOR_STYLES', '../../assets/ckeditor/content.css'],
		fileName: 'export-pdf-bomoc.pdf',
		appID: 'cke5-demos',
		converterOptions: {
			format: 'Tabloid',
	...
	exportWord: {
		stylesheets: ['EDITOR_STYLES', '../../assets/ckeditor/content.css'],
		fileName: 'export-word-bomoc.docx',
		appID: 'cke5-demos',
		converterOptions: {
			format: 'A4',
			margin_top: exportVerticalSpace,
