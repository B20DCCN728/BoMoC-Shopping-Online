<template>
    ...
    <div class="grid">
        ...
        <span class="footer-bottom__left">Copyright © 2023 Nguyen Hoang Viet</span>
...
.footer-header__right-form {
  display: flex;
}

.footer-header__right-email {
  min-width: 400px;
  font-size: 1.4rem;
...
.footer-header__right-submit:hover {
